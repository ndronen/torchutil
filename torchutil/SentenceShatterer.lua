...
local SentenceShatterer, parent = torch.class('nn.SentenceShatterer', 'nn.Module')

--[[ The constructor....
]]
function SentenceShatterer:__init(nFilters, filterWidth, wordDim)
  parent.__init(self)
  -- ?
  --[[
...
function SentenceShatterer:updateOutput(input)
  --[[
...
function SentenceShatterer:updateGradInput(input, gradOutput)
...
function SentenceShatterer:accGradParameters(input, gradOutput, scale)
end

-- we do not need to accumulate parameters when sharing
SentenceShatterer.sharedAccUpdateGradParameters = SentenceShatterer.accUpdateGradParameters
